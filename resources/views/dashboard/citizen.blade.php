            ...
            @foreach($concerns as $concern)
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="status {{ strtolower(str_replace(' ', '-', $concern->status)) }}">
                            <p class="{{ strtolower(str_replace(' ', '-', $concern->status)) }}">
                    ...
                    <div class="details">
                        <div class="category-wrapper">
                            <p><span class="icon"><i class="fa-regular fa-map"></i></span>{{ $concern->category }}</p>
                        </div>
                        <div class="location-wrapper">
                            <p class="location"><span class="icon"><i class="fa-solid fa-location-dot"></i></span>{{ $concern->city }}</p>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <div class="date">
                            <p><span class="icon"><i class="fa-regular fa-clock"></i></span>{{ $concern->created_at->format('M d, Y') }}</p>
                        </div>
